...
If you want to manage `hodex` separately without affecting your existing `codex` setup, use `hodexctl`.
...
For details, see the [Hodexctl guide](./scripts/hodexctl/README.md).
