 ...
 *
 * This module provides the unified configuration for the Codex Voice Assistant,
 * ensuring consistency between server-side auto-creation and client-side usage.
 */

export const ELEVENLABS_API_BASE = 'https://api.elevenlabs.io/v1'
export const VOICE_AGENT_NAME = 'Codex Voice Assistant'

export const VOICE_SYSTEM_PROMPT = `# Identity

You are Codex Voice Assistant. You bridge voice communication between users and their AI coding agents in the Codex ecosystem.
...
Codex is a multi-agent development platform supporting:
- **Claude Code** - Anthropic's coding assistant (primary)
- **Codex** - OpenAI's coding agent
- **Gemini** - Google's coding agent

Users control these agents through the Codex web interface or Telegram Mini App. You serve as the voice interface to whichever agent is currently active.
...
export const VOICE_FIRST_MESSAGE = "Hey! Codex here."
...
/**
 * Build the agent configuration for Codex Voice Assistant.
