export default {
  ...
  'login.server.description': 'Set hub origin for API and live updates.',
  'login.server.current': 'Current:',
  'login.server.origin': 'Hub origin',
  'login.server.placeholder': 'https://codex.example.com',
  ...
  'newSession.recent.clear': 'Clear',
  'newSession.recent.remove': 'Remove',
  'newSession.directory.notFound': 'Directory not found on machine.',
  ...
  'newSession.reasoningEffort': 'Thinking level',
  'newSession.reasoningEffort.optional': 'optional',
  'newSession.reasoningEffort.auto': 'Auto',
  'newSession.reasoningEffort.none': 'None',
  'newSession.reasoningEffort.minimal': 'Minimal',
  'newSession.reasoningEffort.low': 'Low',
  'newSession.reasoningEffort.medium': 'Medium',
  'newSession.reasoningEffort.high': 'High',
  'newSession.reasoningEffort.xhigh': 'Extra High',
  ...
  // Install prompt
  'install.title': 'Install Codex',
  'install.description': 'Add Codex to your home screen for quick access.',
