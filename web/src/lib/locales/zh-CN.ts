export default {
  ...
  'login.server.description': '设置 Codex 服务器地址以使用 API 和实时更新。',
  ...
  'newSession.recent.clear': '清空',
  'newSession.recent.remove': '移除',
  'newSession.directory.notFound': '目录在机器上不存在。',
  ...
  'newSession.reasoningEffort': '思考等级',
  'newSession.reasoningEffort.optional': '可选',
  'newSession.reasoningEffort.auto': '自动',
  'newSession.reasoningEffort.none': '无',
  'newSession.reasoningEffort.minimal': '最少',
  'newSession.reasoningEffort.low': '低',
  'newSession.reasoningEffort.medium': '中',
  'newSession.reasoningEffort.high': '高',
  'newSession.reasoningEffort.xhigh': '极高',
  ...
  // Install prompt
  'install.title': '安装 Codex',
  'install.description': '将 Codex 添加到主屏幕以便快速访问。',
  'install.button': '安装',
