...
import { PROTOCOL_VERSION } from '@codex/protocol'
...
export default function SettingsPage() {
    ...
    const [voiceLanguage, setVoiceLanguage] = useState<string | null>(() => {
        return localStorage.getItem('codex-voice-lang')
    })
    ...
    const handleVoiceLanguageChange = (language: Language) => {
        ...
        if (language.code === null) {
            localStorage.removeItem('codex-voice-lang')
        } else {
            localStorage.setItem('codex-voice-lang', language.code)
        }
