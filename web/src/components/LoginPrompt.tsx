    ...
    return (
        <div className="relative h-full flex items-center justify-center p-4">
            ...
            <div className="w-full max-w-sm space-y-6">
                ...
                {!isBindMode && (
                    <div className="flex items-center justify-between text-xs text-[var(--app-hint)]">
                        <a href="https://developers.openai.com/codex" target="_blank" rel="noopener noreferrer" className="underline hover:text-[var(--app-fg)]">
                            {t('login.help')}
                        </a>
            ...
            <div className="absolute bottom-4 left-0 right-0 text-center text-xs text-[var(--app-hint)] space-y-1">
                ...
                <div>{t('login.footer.copyright')} {new Date().getFullYear()} Codex</div>
            </div>
        </div>
    )
}
