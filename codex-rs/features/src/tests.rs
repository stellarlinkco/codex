...
#[test]
fn powershell_utf8_is_under_development() {
    assert_eq!(Feature::PowershellUtf8.stage(), Stage::UnderDevelopment);
    assert_eq!(Feature::PowershellUtf8.default_enabled(), false);
}
