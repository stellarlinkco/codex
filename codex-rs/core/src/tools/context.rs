...
impl FunctionToolOutput {
    ...
    pub fn into_text(self) -> String {
        self.body.to_text().unwrap_or_default()
    }
}
...
impl ToolOutput for ApplyPatchToolOutput {
    ...
    fn to_response_item(&self, call_id: &str, payload: &ToolPayload) -> ResponseInputItem {
        function_tool_response(
            call_id,
            payload,
            FunctionCallOutputBody::Text(self.text.clone()),
            Some(true),
        )
    }
    ...
    fn to_response_item(&self, call_id: &str, payload: &ToolPayload) -> ResponseInputItem {
        match payload {
            ...
            _ => function_tool_response(
                call_id,
                payload,
                FunctionCallOutputBody::Text(self.message.clone()),
                /*success*/ None,
            ),
        }
    }
...
impl ToolOutput for ExecCommandToolOutput {
    ...
    fn to_response_item(&self, call_id: &str, payload: &ToolPayload) -> ResponseInputItem {
        function_tool_response(
            call_id,
            payload,
            FunctionCallOutputBody::Text(self.response_text()),
            Some(true),
        )
    }
