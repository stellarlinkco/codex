...
fn request_permissions_tool_includes_full_permission_schema() {
    ...
    assert_eq!(additional_properties, &Some(false.into()));
    assert!(macos_properties.contains_key("macos_preferences"));
    assert!(macos_properties.contains_key("macos_automation"));
    assert!(macos_properties.contains_key("macos_launch_services"));
    assert!(macos_properties.contains_key("macos_accessibility"));
    assert!(macos_properties.contains_key("macos_calendar"));
    assert!(macos_properties.contains_key("macos_reminders"));
    assert!(macos_properties.contains_key("macos_contacts"));
}
