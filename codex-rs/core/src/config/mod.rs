...
use crate::config::permissions::FileSystemSandboxPolicyExt;
...
"#;
    ...
    fn test_precedence_fixture_with_o3_profile() -> std::io::Result<()> {
        ...
        assert_eq!(
            Config {
                ...
                config_layer_stack: o3_profile_config.config_layer_stack.clone(),
    ...
    fn test_precedence_fixture_with_gpt3_profile() -> std::io::Result<()> {
        ...
        let expected_gpt3_profile_config = Config {
            ...
            sqlite_home: fixture.codex_home(),
            log_dir: fixture.codex_home().join("log"),
            config_layer_stack: gpt3_profile_config.config_layer_stack.clone(),
            startup_warnings: Vec::new(),
            history: History::default(),
            ephemeral: false,
            file_opener: UriBasedFileOpener::VsCode,
    ...
    fn test_precedence_fixture_with_zdr_profile() -> std::io::Result<()> {
        ...
        let expected_zdr_profile_config = Config {
            ...
            sqlite_home: fixture.codex_home(),
            log_dir: fixture.codex_home().join("log"),
            config_layer_stack: zdr_profile_config.config_layer_stack.clone(),
            startup_warnings: Vec::new(),
            history: History::default(),
            ephemeral: false,
            file_opener: UriBasedFileOpener::VsCode,
    ...
    fn test_precedence_fixture_with_gpt5_profile() -> std::io::Result<()> {
        ...
        let expected_gpt5_profile_config = Config {
            ...
            sqlite_home: fixture.codex_home(),
            log_dir: fixture.codex_home().join("log"),
            config_layer_stack: gpt5_profile_config.config_layer_stack.clone(),
            startup_warnings: Vec::new(),
            history: History::default(),
            ephemeral: false,
            file_opener: UriBasedFileOpener::VsCode,
