...
impl ConfigEditsBuilder {
    ...
    pub fn set_external_config_migration_prompt_home_last_prompted_at(
        mut self,
        timestamp: i64,
    ) -> Self {
        self.edits
            .push(ConfigEdit::SetNoticeExternalConfigMigrationPromptHomeLastPromptedAt(timestamp));
        self
    }
    ...
    pub fn set_external_config_migration_prompt_project_last_prompted_at(
        mut self,
        project: &str,
        timestamp: i64,
    ) -> Self {
